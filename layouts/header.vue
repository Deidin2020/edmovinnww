<template>
    <div>
        <HomeHeader showHeaderTop="false" ExtraClass="bg-EAECF0" />
        <ScrollToTop />
        <Nuxt />
    ...
    head() {
        return {
            ...
            link: [
                ...
                { rel: 'alternate', hreflang: 'en', href: `https://edmovinn.com/${this.$route.fullPath}` },
                { rel: 'alternate', hreflang: 'ar', href: `https://edmovinn.com/ar${this.$route.fullPath}` },
            ],
            script: [
                {
